...
const createSvargaItemTemplate = (svarga) => `
  <div class="svarga-item">
    ...
    <img class="svarga-item__header__poster lazyload" data-src="${svarga.pictureId ? CONFIG.BASE_IMAGE_URL + svarga.pictureId : 'images/heros/hero-image_4.jpg'}" crossorigin="anonymous" alt="Gambar ${svarga.name}">
    ...
    <h3 class="svarga__title"><a href="/#/detail/${svarga.id}">${svarga.name}</a></h3>
...
const createSvargaDetailTemplate = (svarga) => `
  ...
  <img class="svarga__poster lazyload" data-src="${CONFIG.BASE_IMAGE_URL + svarga.pictureId}" crossorigin="anonymous" alt="Gambar ${svarga.name}" />
